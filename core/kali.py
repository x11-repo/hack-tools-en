...
def main():
    def menu(selected = ""):
        ...
        if selected == "7777":
            ...
            print(Fore.BLUE+f"=====================================\n{Fore.GREEN}[INFO]{Style.RESET_ALL}Hack Tools \nwas updated successfully.\n{Fore.GREEN}[INFO]{Style.RESET_ALL}After 5 seconds it will \n automatically start\n{Fore.BLUE}====================================="+Style.RESET_ALL)
            time.sleep(5)
            os.system("cd && cd hack-tools-en && sudo python3 HackTools.py")
        ...
        if selected == "999":
            ...
            print("[+] Happy hacking <3 <3")
            kkk = input("[+] Return to the menu? (y/n): ")
            print("========================================")
            if kkk == "y":
                main()
                return
        ...
        if menu1 == "007":
            ...
            message = input(Fore.RED+f'Enter you message: ' )
            num = int('1')
            for value in range( num ):
                ...
                value += 1
                print(Fore.GREEN+f'Message sended! Thanks!'+Style.RESET_ALL)
                time.sleep(5)
                exit(0)
        ...
        if menu1 == "014":
            ...
            exit(0)
        if menu1 == "024":
            os.system("cd && cd hack-tools-en/assets/hashcat/ && sudo ./hashcat64.bin --help")
            exit(0)
        if menu1 == "034":
            os.system("sudo john")
            exit(0)
        ...
        if menu1 == "017":
            print(" We'll add it soon. Currently unavailable")
            exit(0)
        if menu1 == "027":
